...
class PlaceReleaseNotesBelowUnreleasedHeadingAction
{
     ...
     * @throws Throwable
     */
    public function execute(Heading $unreleasedHeading, string $latestVersion, string $latestCommitHash, string $headingText, string $releaseDate, ?string $releaseNotes, Document $changelog, string $compareUrlTargetRevision): Document
    {
        ...
        $updatedUrl = $this->generateCompareUrl->generate($repositoryUrl, $latestCommitHash, $compareUrlTargetRevision);
